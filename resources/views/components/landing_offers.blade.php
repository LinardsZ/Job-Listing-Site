...
<div class="grid grid-cols-3 gap-4 my-36 mx-12">
    ...
    <div class="bg-neutral-50 border border-gray-300 p-4 rounded">
        <div class="flex">
            <a href="/listing/{{ $offer->offerid }}"><p class="text-xl uppercase font-bold">{{ $offer->position }}</p></a>
            <p class="border border-emerald-700 rounded ml-auto bg-emerald-700 p-1 text-white font-bold">{{ $offer->salary }} €/mēn</p>
        </div>
