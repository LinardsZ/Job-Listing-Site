...
<html>
    ...
    <body class="bg-neutral-100">
        ...
        <div class="flex flex-col w-1/2 mx-auto my-24">
            <div class="flex flex-row bg-neutral-50 border border-neutral-200 py-4">
                ...
                <div class="flex flex-col pr-4 justify-center">
                    ...
                    ease-in-out duration-300 cursor-pointer select-none">Start a conversation</button>
                    @endif
                </div>
                @else
                <div class="flex flex-col pr-4 justify-center">
        ...
        <span class="material-icons self-end pb-4 cursor-pointer select-none" onclick="closeMessageForm()">close</span>
            <p class="font-bold text-gray-700 text-center mb-12 select-none">Send a message to <span class="font-normal">{{ $data->name }}</span></p>
            <div class="flex flex-col justify-between pb-4">
                <label for="institution" class="font-bold text-gray-700 text-md pr-2 select-none">Message: </label>
            ...
            <input type="submit" value="Send" class="mt-4 block font-bold text-white text-center p-2 bg-gray-800 text-xl border-0 rounded-md border-gray-800 hover:bg-emerald-800 
