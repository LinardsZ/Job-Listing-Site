...
<html>
    <head>
		...
		<title>Admin Panel - View User #{{$user->userid}}</title>
    </head>
        ...
        <div class="flex flex-row bg-neutral-50 border b-l-1">
            <div class="basis-1/7 mr-2 flex flex-col">
                ...
                src="@if(file_exists('storage/avatars/'.$user->userid.'.jpg'))
                    ...
                    {{ asset('no-image.png') }}
                    @endif">
                <a href="{{ route('admin.deletepicture', $user->userid) }}" class="mb-6 text-center font-bold text-gray-700 underline text-sm cursor-pointer hover:text-emerald-700">Delete Picture</a>
            </div>    
            <div class="basis-5/7 shrink-0 pt-12 flex flex-col justify-center">
                ...
                <p class="pb-2 italic text-gray-700"> <span class="font-bold">Created at:</span> {{ $user->created_at }} </p>
            </div>
            <div class="basis-1/7 grow-0 shrink-0 ml-auto mr-24 flex flex-col justify-center">
                ...
                ease-in-out duration-300 cursor-pointer select-none">Delete Profile</a>
                <a href="{{ route('show.admin') }}" class="mt-6 block font-bold text-white text-center p-2 bg-gray-800 text-xl border-0 rounded-md border-gray-800 
                    ease-in-out duration-300 cursor-pointer select-none hover:bg-blue-900">Manage Site</a>
            </div>
        </div>
