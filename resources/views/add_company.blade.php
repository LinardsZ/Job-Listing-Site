    ...
    <body class="bg-neutral-100">
        ...
        <div class="my-24 mx-auto w-1/2">
            <div class="mb-12">
                ...
                <p class="font-bold text-3xl text-gray-700 mt-4 text-center">{{ __('Welcome') }}, {{ $firstname }} {{ $surname }}!</p>
            </div>
            
            <p class="font-bold text-md text-gray-700 text-center mb-8 mt-24">{{ __('Fill out this form to add information about the company you represent') }}:</p>
